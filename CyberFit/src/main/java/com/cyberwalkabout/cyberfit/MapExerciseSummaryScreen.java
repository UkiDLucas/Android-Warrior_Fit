...
public class MapExerciseSummaryScreen extends AppCompatActivity {
    ...
    private void loadPath() {
        ...
        new AsyncTask<Long, Void, List<LocationInfo>>() {
            @Override
            protected List<LocationInfo> doInBackground(Long... params) {
    ...
    private void drawPath() {
        if (locationInfoList != null) {
            if (locationInfoList.size() >= 2) {
                ...
                LocationInfo prevLocationInfo = null;
                ...
                for (int i = 0; i < locationInfoList.size(); i++) {
                    ...
                    if (prevLocationInfo != null) {
                        ...
                        if (LocationInfo.LocationType.PAUSED.equals(locationInfo.getType())) {
                            polyline.add(latLng);
                        } else if (LocationInfo.LocationType.IN_PROGRESS.equals(locationInfo.getType())) {
                            ...
                            polyline.add(latLng);
                            /*}*/
                        } else if (LocationInfo.LocationType.PAUSE.equals(locationInfo.getType())) {
                            ...
                            polyline.getPoints().clear();
                            polyline.add(latLng);
                        } else if (LocationInfo.LocationType.RESUME.equals(locationInfo.getType())) {
                            ...
                            map.addPolyline(polyline.color(prevLocationInfo.getType() == LocationInfo.LocationType.PAUSE ? pausedLineColor : lineColor).width(lineWidth));
                        }
                    } else if (LocationInfo.LocationType.START.equals(locationInfo.getType())) {
