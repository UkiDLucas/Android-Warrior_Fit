...
import com.cyberwalkabout.cyberfit.content.sql.DeleteExerciseSessionById;
import com.cyberwalkabout.cyberfit.content.sql.DeleteFavoriteExerciseId;
import com.cyberwalkabout.cyberfit.content.sql.DeleteSelectedProgramId;
import com.cyberwalkabout.cyberfit.content.sql.DeleteSubscribedProgramId;
import com.cyberwalkabout.cyberfit.content.sql.DeleteUser;
import com.cyberwalkabout.cyberfit.content.sql.InsertExerciseSession;
import com.cyberwalkabout.cyberfit.content.sql.InsertFavoriteExerciseId;
import com.cyberwalkabout.cyberfit.content.sql.InsertLocationInfo;
import com.cyberwalkabout.cyberfit.content.sql.InsertSelectedProgramId;
import com.cyberwalkabout.cyberfit.content.sql.InsertSocialProfile;
import com.cyberwalkabout.cyberfit.content.sql.InsertSubscribedProgramId;
import com.cyberwalkabout.cyberfit.content.sql.InsertUser;
import com.cyberwalkabout.cyberfit.content.sql.QueryAllAuthors;
import com.cyberwalkabout.cyberfit.content.sql.QueryAllExercises;
import com.cyberwalkabout.cyberfit.content.sql.QueryAllPrograms;
import com.cyberwalkabout.cyberfit.content.sql.QueryAllProgramsSelected;
import com.cyberwalkabout.cyberfit.content.sql.QueryAllProgramsWithAuthorNames;
import com.cyberwalkabout.cyberfit.content.sql.QueryAuthorByExerciseId;
import com.cyberwalkabout.cyberfit.content.sql.QueryAuthorById;
import com.cyberwalkabout.cyberfit.content.sql.QueryCompletedExerciseSession;
import com.cyberwalkabout.cyberfit.content.sql.QueryCountFavoriteExerciseById;
import com.cyberwalkabout.cyberfit.content.sql.QueryCountLocationInfoByExerciseSessionId;
import com.cyberwalkabout.cyberfit.content.sql.QueryCountSubscribedProgramById;
import com.cyberwalkabout.cyberfit.content.sql.QueryExerciseById;
import com.cyberwalkabout.cyberfit.content.sql.QueryExerciseSessions;
import com.cyberwalkabout.cyberfit.content.sql.QueryExerciseToProgramAssociations;
import com.cyberwalkabout.cyberfit.content.sql.QueryExercises;
import com.cyberwalkabout.cyberfit.content.sql.QueryExercisesByProgramId;
import com.cyberwalkabout.cyberfit.content.sql.QueryInProgressExerciseSession;
import com.cyberwalkabout.cyberfit.content.sql.QueryLocationInfo;
import com.cyberwalkabout.cyberfit.content.sql.QueryLocationInfoById;
import com.cyberwalkabout.cyberfit.content.sql.QueryMapExerciseHistory;
import com.cyberwalkabout.cyberfit.content.sql.QueryMostRecentCompletedExerciseSession;
import com.cyberwalkabout.cyberfit.content.sql.QueryMostRecentExerciseHistoryRecord;
import com.cyberwalkabout.cyberfit.content.sql.QueryMostRecentLocationInfo;
import com.cyberwalkabout.cyberfit.content.sql.QueryNumberOfExercisesCompletedToday;
import com.cyberwalkabout.cyberfit.content.sql.QueryProgramById;
import com.cyberwalkabout.cyberfit.content.sql.QueryProgramsByExerciseId;
import com.cyberwalkabout.cyberfit.content.sql.QuerySocialProfilesBySocialId;
import com.cyberwalkabout.cyberfit.content.sql.QuerySocialProfilesByUserId;
import com.cyberwalkabout.cyberfit.content.sql.QueryUser;
import com.cyberwalkabout.cyberfit.content.sql.UpdateExerciseSession;
import com.cyberwalkabout.cyberfit.content.sql.UpdateExerciseSessionState;
import com.cyberwalkabout.cyberfit.content.sql.UpdateMostRecentLocationInfoType;
import com.cyberwalkabout.cyberfit.content.sql.UpdateSocialProfile;
import com.cyberwalkabout.cyberfit.content.sql.UpdateUser;
...
public class CyberFitContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            break;
            case CyberFitUriMatcher.SOCIAL_PROFILE: {
                if (!TextUtils.isEmpty(uri.getQueryParameter(SocialProfileTable.COLUMN_USER_ID))) {
                    cursor = new QuerySocialProfilesByUserId(getContext(), database, uri, projection, selection, selectionArgs, sortOrder).execute();
                } else if (!TextUtils.isEmpty(uri.getQueryParameter(SocialProfileTable.COLUMN_SOCIAL_ID))) {
