...
public class CyberFitUriMatcher extends UriMatcher {
    ...
    public CyberFitUriMatcher() {
        ...
        addURI(CyberFitContentProvider.AUTHORITY, ProgramTable.TABLE_NAME + "/" + SelectedProgramTable.TABLE_NAME, ALL_PROGRAMS_SELECTED);
        addURI(CyberFitContentProvider.AUTHORITY, AuthorTable.TABLE_NAME, ALL_AUTHORS);
        addURI(CyberFitContentProvider.AUTHORITY, AuthorTable.TABLE_NAME + "/#", AUTHOR_BY_ID);
        addURI(CyberFitContentProvider.AUTHORITY, ExerciseTable.TABLE_NAME, ALL_EXERCISES);
        addURI(CyberFitContentProvider.AUTHORITY, ExerciseTable.TABLE_NAME + "/" + ProgramTable.TABLE_NAME + "/#", EXERCISES_BY_PROGRAM_ID);
        addURI(CyberFitContentProvider.AUTHORITY, ExerciseToProgramTable.TABLE_NAME, ALL_EXERCISE_TO_PROGRAM_ASSOCIATIONS);
        addURI(CyberFitContentProvider.AUTHORITY, ProgramTable.TABLE_NAME + "/" + URI_SEGMENT_JOIN + "/" + AuthorTable.TABLE_NAME, ALL_PROGRAMS_WITH_AUTHORS);
        addURI(CyberFitContentProvider.AUTHORITY, ExerciseTable.TABLE_NAME + "/" + URI_SEGMENT_JOIN + "/" + ExerciseTable.ALIAS_PROGRAM_NAMES, ALL_EXERCISES_WITH_PROGRAM_NAMES);
        addURI(CyberFitContentProvider.AUTHORITY, SelectedProgramTable.TABLE_NAME + "/#", SELECTED_PROGRAM);
        addURI(CyberFitContentProvider.AUTHORITY, SubscribedProgramTable.TABLE_NAME + "/#", SUBSCRIBED_PROGRAM);
        addURI(CyberFitContentProvider.AUTHORITY, FavoriteExerciseTable.TABLE_NAME, FAVORITE_EXERCISE);
        ...
        addURI(CyberFitContentProvider.AUTHORITY, ProgramTable.TABLE_NAME + "/" + ExerciseTable.TABLE_NAME + "", PROGRAMS_BY_EXERCISE_ID);
        addURI(CyberFitContentProvider.AUTHORITY, ExerciseTable.TABLE_NAME + "/" + AuthorTable.TABLE_NAME, AUTHOR_BY_EXERCISE_ID);
        ...
        addURI(CyberFitContentProvider.AUTHORITY, LocationInfoTable.TABLE_NAME + "/" + URI_SEGMENT_MOST_RECENT + "/" + LocationInfoTable.COLUMN_TYPE + "/#", MOST_RECENT_LOCATION_INFO_STATE);
        ...
        addURI(CyberFitContentProvider.AUTHORITY, ExerciseSessionTable.TABLE_NAME + "/" + ExerciseTable.COLUMN_MAP_REQUIRED + "/", MAP_EXERCISE_HISTORY_RECORD);
        addURI(CyberFitContentProvider.AUTHORITY, LocationInfoTable.TABLE_NAME + "/" + URI_SEGMENT_COUNT + "/#", COUNT_LOCATION_INFO_BY_EXERCISE_HISTORY_RECORD_ID);
        addURI(CyberFitContentProvider.AUTHORITY, LocationInfoTable.TABLE_NAME, LOCATION_INFO);
        addURI(CyberFitContentProvider.AUTHORITY, LocationInfoTable.TABLE_NAME + "/#", LOCATION_INFO_BY_ID);
        addURI(CyberFitContentProvider.AUTHORITY, LocationInfoTable.TABLE_NAME + "/" + URI_SEGMENT_MOST_RECENT + "/", MOST_RECENT_LOCATION_INFO_FOR_EXERCISE);
        addURI(CyberFitContentProvider.AUTHORITY, UserTable.TABLE_NAME, USER);
        addURI(CyberFitContentProvider.AUTHORITY, UserTable.TABLE_NAME + "/#", USER_BY_ID);
        addURI(CyberFitContentProvider.AUTHORITY, SocialProfileTable.TABLE_NAME, SOCIAL_PROFILE);
        addURI(CyberFitContentProvider.AUTHORITY, SocialProfileTable.TABLE_NAME + "/#", SOCIAL_PROFILE_BY_ID);
