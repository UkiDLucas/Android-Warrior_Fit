...
public class MapExerciseScreen extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener, View.OnClickListener, /*ISimpleDialogListener,*/ LoaderManager.LoaderCallbacks<Cursor>, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private com.warriorfitapp.model.v2.LocationInfo currentLocation;
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (exerciseSession != null) {
                ...
                if (match) {
                    ...
                    com.warriorfitapp.model.v2.LocationInfo locationInfo = contentProviderAdapter.getLocationInfoById(getApplicationContext(), id);
    ...
    private void restorePath(final ExerciseSession exerciseSession) {
        ...
        new AsyncTask<Void, Void, List<com.warriorfitapp.model.v2.LocationInfo>>() {

            @Override
            protected List<com.warriorfitapp.model.v2.LocationInfo> doInBackground(Void... params) {
    ...
    private void drawRestoredPath(List<com.warriorfitapp.model.v2.LocationInfo> locations) {
        if (locations != null) {
            if (locations.size() >= 2) {
    ...
    private void appendLocationToPath(com.warriorfitapp.model.v2.LocationInfo newLocation) {
        if (currentLocation != null) {
            int lineColor = activeLineColor;

            if (com.warriorfitapp.model.v2.LocationInfo.LocationType.PAUSE.equals(currentLocation.getType()) || com.warriorfitapp.model.v2.LocationInfo.LocationType.PAUSED.equals(currentLocation.getType())) {
