...
public class UriHelper {
    ...
    public Uri allExercises() {
        return Uri.withAppendedPath(CyberFitContentProvider.CONTENT_URI, com.warriorfitapp.db.sqlite.schema.table.ExerciseTable.TABLE_NAME);
    }
    ...
    public Uri allProgramsSelected() {
        ...
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.SelectedProgramTable.TABLE_NAME);
    ...
    public Uri allProgramsWithAuthors(String programNameSearchKeyword) {
        ...
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.AuthorTable.TABLE_NAME);
    ...
    public Uri allExercisesWithProgramNames(String exerciseNameSearchKeyword, boolean favoritesOnly) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseTable.TABLE_NAME);
        builder.appendPath(CyberFitUriMatcher.URI_SEGMENT_JOIN);
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseTable.ALIAS_PROGRAM_NAMES);

        if (!TextUtils.isEmpty(exerciseNameSearchKeyword)) {
            builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.ExerciseTable.COLUMN_NAME, exerciseNameSearchKeyword);
        }

        if (favoritesOnly) {
            builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.FavoriteExerciseTable.TABLE_NAME, String.valueOf(favoritesOnly));
        }
    ...
    public Uri subscribedProgram(long programId) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.SubscribedProgramTable.TABLE_NAME);
        builder.appendPath(Long.toString(programId));
        return builder.build();
    }
    ...
    public Uri favoriteExercise(String exerciseId) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.FavoriteExerciseTable.TABLE_NAME);
    ...
    public Uri allExerciseSessions() {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.TABLE_NAME);
        return builder.build();
    }

    public Uri allExerciseSessions(com.warriorfitapp.model.v2.ExerciseState exerciseState) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.TABLE_NAME);
        builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.COLUMN_STATE, exerciseState.name());
        return builder.build();
    }
    ...
    public Uri exerciseSessionState(long id, com.warriorfitapp.model.v2.ExerciseState state) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.TABLE_NAME);
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.COLUMN_STATE);
        builder.appendPath(Long.toString(id));
        builder.appendQueryParameter(Const.STATE, state.name());
        return builder.build();
    }

    public Uri mostRecentLocationInfoState(long exerciseSessionId, com.warriorfitapp.model.v2.LocationInfo.LocationType type) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.LocationInfoTable.TABLE_NAME);
        builder.appendPath(CyberFitUriMatcher.URI_SEGMENT_MOST_RECENT);
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.LocationInfoTable.COLUMN_TYPE);
    ...
    public Uri locationInfo(long exerciseHistoryRecordId, com.warriorfitapp.model.v2.LocationInfo.LocationType... types) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.LocationInfoTable.TABLE_NAME);
        builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.LocationInfoTable.COLUMN_EXERCISE_SESSION_ID, Long.toString(exerciseHistoryRecordId));

        if (types != null) {
            builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.LocationInfoTable.COLUMN_TYPE, Joiner.on(",").join(types));
        }
    ...
    public Uri allMapExerciseHistoryRecordsInProgressAndPaused() {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.TABLE_NAME);
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.ExerciseTable.COLUMN_MAP_REQUIRED);
    ...
    public Uri user() {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.UserTable.TABLE_NAME);
        return builder.build();
    }
    ...
    public Uri socialProfile() {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.SocialProfileTable.TABLE_NAME);
        return builder.build();
    }
    ...
    public Uri socialProfileByUserId(long userId) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.SocialProfileTable.TABLE_NAME);
        builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.SocialProfileTable.COLUMN_USER_ID, Long.toString(userId));
        return builder.build();
    }
    ...
    public Uri socialProfileBySocialId(String socialId) {
        Uri.Builder builder = CyberFitContentProvider.CONTENT_URI.buildUpon();
        builder.appendPath(com.warriorfitapp.db.sqlite.schema.table.SocialProfileTable.TABLE_NAME);
        builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.SocialProfileTable.COLUMN_SOCIAL_ID, socialId);
        return builder.build();
    }
    ...
    public Uri numberOfExercisesCompletedToday(Long userId) {
        ...
        if (userId != null) {
            builder.appendQueryParameter(com.warriorfitapp.db.sqlite.schema.table.ExerciseSessionTable.COLUMN_USER_ID, Long.toString(userId));
        }
        return builder.build();
    }
