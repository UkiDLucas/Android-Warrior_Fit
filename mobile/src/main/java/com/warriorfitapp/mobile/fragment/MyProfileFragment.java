...
import com.warriorfitapp.mobile.LoginScreen;
...
import com.warriorfitapp.mobile.widget.dialog.AgePickerDialog;
import com.warriorfitapp.mobile.widget.dialog.HeightInputDialog;
import com.warriorfitapp.mobile.widget.dialog.UserWeightInputDialog;
import com.warriorfitapp.mobile.widget.dialog.WaistInputDialog;
...
public class MyProfileFragment extends Fragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, TextWatcher, LoaderManager.LoaderCallbacks<Cursor> {
            ...
            if (data != null && (data.getData() != null || data.hasExtra("data"))) {
                new AsyncTask<Void, Void, Uri>() {
                    ...
                    protected Uri doInBackground(Void... params) {
                        ...
                        values.put(com.warriorfitapp.db.sqlite.schema.table.UserTable.COLUMN_IMAGE_URI, imageUri.toString());
                ...
                case R.id.btn_age:
                    ...
                    agePickerDialog.setListener(new AgePickerDialog.OnAgeSetListener() {
                        ...
                        public void onAgeSet(View view, int age) {
                            ...
                            new AsyncTask<com.warriorfitapp.model.v2.User, Void, Void>() {
                                @Override
                                protected Void doInBackground(com.warriorfitapp.model.v2.User... params) {
                                    ContentValues values = new ContentValues(1);
                                    values.put(com.warriorfitapp.db.sqlite.schema.table.UserTable.COLUMN_AGE, params[0].getAge());
                                    ContentProviderAdapter.getInstance().updateUser(getActivity(), currentUser.getId(), values);
                                    return null;
                                }
                            }.execute(currentUser);
                    ...
                    heightInputDialog.setListener(new HeightInputDialog.OnHeightSetListener() {
                        ...
                        public void onHeightSet(View view, double height) {
                            ...
                            new AsyncTask<com.warriorfitapp.model.v2.User, Void, Void>() {
                                ...
                                protected Void doInBackground(com.warriorfitapp.model.v2.User... params) {
                                    ContentValues values = new ContentValues(1);
                                    values.put(com.warriorfitapp.db.sqlite.schema.table.UserTable.COLUMN_HEIGHT, params[0].getHeight());
                                    ContentProviderAdapter.getInstance().updateUser(getActivity(), currentUser.getId(), values);
                                    return null;
                                }
                            }.execute(currentUser);
                    ...
                    userWeightInputDialog.setListener(new UserWeightInputDialog.OnWeightSetListener() {
                        ...
                        public void onWeightSet(View v, float weight, String unit) {
                            ...
                            new AsyncTask<com.warriorfitapp.model.v2.User, Void, Void>() {
                                ...
                                protected Void doInBackground(com.warriorfitapp.model.v2.User... params) {
                                    ContentValues values = new ContentValues(1);
                                    values.put(com.warriorfitapp.db.sqlite.schema.table.UserTable.COLUMN_WEIGHT, params[0].getWeight());
                                    ContentProviderAdapter.getInstance().updateUser(getActivity(), currentUser.getId(), values);
                                    return null;
                                }
                            }.execute(currentUser);
                    ...
                    waistInputDialog.setListener(new WaistInputDialog.OnWaistSetListener() {
                        ...
                        public void onWaistSet(View view, int waist) {
                            ...
                            new AsyncTask<com.warriorfitapp.model.v2.User, Void, Void>() {
                                ...
                                protected Void doInBackground(com.warriorfitapp.model.v2.User... params) {
                                    ContentValues values = new ContentValues(1);
                                    values.put(com.warriorfitapp.db.sqlite.schema.table.UserTable.COLUMN_WAIST, params[0].getWaist());
                                    ContentProviderAdapter.getInstance().updateUser(getActivity(), currentUser.getId(), values);
                                    return null;
                                }
                            }.execute(currentUser);
    ...
    public void onTextChanged(CharSequence text, int start, int before, int count) {
        if (!suppressUserUpdates && currentUser != null) {
            ...
            contentValues.put(com.warriorfitapp.db.sqlite.schema.table.UserTable.COLUMN_DISPLAY_NAME, text.toString());
