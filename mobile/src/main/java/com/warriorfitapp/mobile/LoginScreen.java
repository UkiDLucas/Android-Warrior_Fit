    ...
    private void signInGoogleAccount(final String accountName) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String token) {
                ...
                final com.warriorfitapp.model.v2.User user = new com.warriorfitapp.model.v2.User();
                user.setUsername(accountName);
                user.setAccountType(accountType);

                final com.warriorfitapp.model.v2.SocialProfile socialProfile = new com.warriorfitapp.model.v2.SocialProfile();
