...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    private boolean displayConfirmationDialog = true;
     ...
     *                 dismiss this view.
     */
    public SwipeDismissTouchListener(View view, Object token, OnDismissCallback callback, View.OnClickListener listener) {
    ...
    public SwipeDismissTouchListener(View view, Object token, OnDismissCallback callback, View.OnClickListener listener, boolean displayConfirmationDialog) {
        this(view, token, callback, listener);
        this.displayConfirmationDialog = displayConfirmationDialog;
    }
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss) {
                    if (displayConfirmationDialog) {
                        // dismiss
                        new AlertDialog.Builder(mView.getContext()).setMessage(mView.getContext().getString(R.string.delete_record_confirmation_notice)).setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            @Override
