...
public class BasicCyberFitContentProviderTest extends AndroidTestCase {
    ...
    public void testQueryAllAuthors() throws Exception {
        Uri uri = Uri.withAppendedPath(CyberFitContentProvider.CONTENT_URI, com.warriorfitapp.db.sqlite.schema.table.AuthorTable.instance().getName());

        Cursor cursor = null;
        try {
            cursor = contentResolver.query(uri, com.warriorfitapp.db.sqlite.schema.table.AuthorTable.instance().getColumnNames(), null, null, null);
    ...
    public void testQueryAuthorById() throws Exception {
        int authorId = 1;
        Uri uri = Uri.withAppendedPath(CyberFitContentProvider.CONTENT_URI, com.warriorfitapp.db.sqlite.schema.table.AuthorTable.instance().getName() + "/" + authorId);
    ...
    public void testQueryAllExerciseToProgramRelationships() throws Exception {
        Uri uri = Uri.withAppendedPath(CyberFitContentProvider.CONTENT_URI, com.warriorfitapp.db.sqlite.schema.table.ExerciseToProgramTable.instance().getName());

        Cursor cursor = null;
        try {
            cursor = contentResolver.query(uri, com.warriorfitapp.db.sqlite.schema.table.ExerciseToProgramTable.instance().getColumnNames(), null, null, null);
    ...
    private void verifyAuthorRow(Cursor cursor) {
        long id = cursor.getLong(cursor.getColumnIndex(com.warriorfitapp.db.sqlite.schema.table.AuthorTable.COLUMN_ID));
        String name = cursor.getString(cursor.getColumnIndex(com.warriorfitapp.db.sqlite.schema.table.AuthorTable.COLUMN_NAME));
    ...
    private void verifyExerciseToProgramRow(Cursor cursor) {
        long id = cursor.getLong(cursor.getColumnIndex(com.warriorfitapp.db.sqlite.schema.table.ExerciseToProgramTable.COLUMN_ID));
        long exerciseId = cursor.getLong(cursor.getColumnIndex(com.warriorfitapp.db.sqlite.schema.table.ExerciseToProgramTable.COLUMN_EXERCISE_ID));
        long programId = cursor.getLong(cursor.getColumnIndex(com.warriorfitapp.db.sqlite.schema.table.ExerciseToProgramTable.COLUMN_PROGRAM_ID));
