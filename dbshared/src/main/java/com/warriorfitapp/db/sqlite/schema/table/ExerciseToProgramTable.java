...
public class ExerciseToProgramTable extends DBTable {
    ...
    public String getCreateSqlStatement() {
        return "create table " + TABLE_NAME
                ...
                foreignKeyConstraint(COLUMN_EXERCISE_ID, com.warriorfitapp.db.sqlite.schema.table.ExerciseTable.TABLE_NAME) + ", " +
                foreignKeyConstraint(COLUMN_PROGRAM_ID, com.warriorfitapp.db.sqlite.schema.table.ProgramTable.TABLE_NAME)
                + ")";
    }
