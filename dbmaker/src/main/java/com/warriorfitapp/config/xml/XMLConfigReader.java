...
import com.warriorfitapp.config.ConfigReader;
...
public class XMLConfigReader implements ConfigReader {
    ...
    public Config readConfig(InputStream in) throws ConfigReaderException {
        ...
        com.warriorfitapp.model.v2.Author author = null;
        Exercise exercise = null;
        com.warriorfitapp.model.v2.Program program = null;
                ...
                switch (event) {
                    case XMLStreamConstants.START_ELEMENT: {
                        ...
                        if (XMLConfigConst.TAG_ROOT.equals(currentTag)) {
                            ...
                            author = new com.warriorfitapp.model.v2.Author();
                            ...
                            program = new com.warriorfitapp.model.v2.Program();
